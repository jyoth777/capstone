...
class DashboardRecyclerAdapter(val context: Context, val itemList: ArrayList<Event>) :
    RecyclerView.Adapter<DashboardRecyclerAdapter.DashboardViewHolder>() {//links adapter class and the recycler view together also provides view holder to the recycler view
    ...
    override fun onBindViewHolder(holder: DashboardViewHolder, position: Int) {
        ...
        val url = "http://172.20.10.5:3000/like"
        holder.fav.setOnClickListener {

            val jsonobj = JSONObject()
            jsonobj.put("eventId", book.id);
            ...
            val reqobj =
                object : JsonObjectRequest(Request.Method.POST, url, jsonobj, {
                    ...
                    override fun getBody(): ByteArray {
                        ...
                        // on below line we are passing our key
                        // and value pair to our parameters.
                        params["eventId"] = book.id.toString();
