...
import com.xperiencelabs.armenu.adapter.FragmentRecyclerAdapter
...
//    )
    ...
    lateinit var recyclerAdapter: FragmentRecyclerAdapter
    ...
    override fun onCreateView(
        ...
        val url = "http://172.20.10.5:3000/liked-events"
                ...
                object : JsonObjectRequest(Method.GET, url, null, Response.Listener {
                    try {
                        ...
                        if (success) {
                            ...
                            recyclerAdapter = FragmentRecyclerAdapter(
                                activity as Context,
                                booklist
